...
export default function AllRecordsPage() {
  ...
  useEffect(() => {
    ...
    setRecords(getRecords().filter((r) => r.type !== "logic"))
  }, [])
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <div className="flex items-center justify-between px-4 pt-12 pb-4">
        ...
        <h1 className="text-lg font-semibold text-foreground">全部记录</h1>
        <div className="w-10" />
      </div>
      ...
      <div className="flex-1 px-4 space-y-3 pb-8">
        <AnimatePresence>
          {displayed.map((r, i) => (
            ...
            >
              ...
              {/* Star button floats outside Link */}
              <button
                type="button"
        ...
        {displayed.length === 0 && (
          <div className="text-center py-16">
            <p className="text-muted-foreground text-sm">暂无记录，去完成一次练习吧</p>
          </div>
        )}
      </div>
    </div>
